...
{% include image-gallery.html folder="/assets/uploads/images/kyoto/9" caption="Not a bad view!" %}
...
After our delicious carby breakfast, we hopped on the subway to visit the [Kyoto Aquarium (京都水族館)](https://www.japan-guide.com/e/e3971.html). The journey was a bit of a trek, especially with the snow, but it was worth it. A quick fit check, of course:

{% include image-gallery.html folder="/assets/uploads/images/kyoto/15" caption="Slay. " %}
